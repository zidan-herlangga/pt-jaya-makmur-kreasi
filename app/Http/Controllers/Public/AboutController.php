...
class AboutController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $seo = $this->seoService->forPage(
            ...
            'PT. Jaya Makmur adalah perusahaan jasa reklame dan billboard profesional. Berpengalaman dalam menyediakan media promosi luar ruang di Jabodetabek dan luar Jabodetabek.',
            'tentang kami, PT Jaya Makmur, perusahaan reklame, jasa billboard, media luar ruang'
        )->render();

        return view('public.about', compact(
            'portfolioCount', 'pointCount', 'postCount', 'latestPortfolios', 'seo'
        ));
    }
}
