...
@section('content')
    ...
    <article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 my-8">
            ...
            <div class="p-8 lg:p-12">
                <div class="flex flex-wrap items-center gap-3 text-sm text-slate-500 mb-4">
                    @if ($portfolio->category)
                        <span
                            class="text-xs font-semibold text-green-600 bg-green-50 px-2.5 py-1 rounded-full">{{ $portfolio->category->name }}</span>
                    @endif
                        ...
                        <article
                            ...
                            <div class="p-4">
                                <h3 class="font-bold text-slate-900">
                                    <a href="{{ route('portofolio.show', $related) }}"
