<aside
    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto overflow-x-hidden">
            ...
            {{-- Sistem --}}
            @php
                $sistemActive = request()->routeIs('admin.users.*') || request()->routeIs('admin.settings.*') || request()->routeIs('admin.ai-models.*');
            @endphp
            <x-admin-nav-dropdown label="Sistem" :active="$sistemActive" :defaultOpen="$sistemActive"
                ...
                <x-admin-nav-link href="{{ route('admin.ai-models.index') }}" :active="request()->routeIs('admin.ai-models.*')"
