...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('admin.portfolios.update', $portfolio) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6" x-data="{ autoSlug: false }">
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-slate-700 mb-1">Judul <span class="text-rose-500">*</span></label>
                <input type="text" name="title" value="{{ old('title', $portfolio->title) }}" required x-ref="title"
            ...
            <div>
                ...
                <input type="text" name="slug" x-ref="slug" value="{{ old('slug', $portfolio->slug) }}"
